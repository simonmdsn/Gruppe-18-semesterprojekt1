 ...
 * @author Lukas
 */
public class FXMLWashingtonMapController implements Initializable {
    @FXML
    private Button washSouthButton;
    @FXML
    private Button washNorthButton;
    @FXML
    private Button washEastButton;
    @FXML
    private Button washWestButton;
    @FXML
    private Label gamePointsLabel;
    @FXML
    private Button washPlayButton;
    @FXML
    ...
    @FXML
    private void handleWashSouthButton(ActionEvent event) throws IOException {
    ...
    @FXML
    private void handleWashNorthButton(ActionEvent event) throws IOException {
        mapLabel.setText("You can't go in that direction!");
    }

    @FXML
    private void handleWashEastButton(ActionEvent event) {
        mapLabel.setText("You can't go in that direction!");
    }

    @FXML
    private void handleWashWestButton(ActionEvent event) {
        mapLabel.setText("You can't go in that direction!");        
    }
